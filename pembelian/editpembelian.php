    ...
    <?php while($row = mysqli_fetch_assoc($result)): ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input  readonly required type="text" name="jenis" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  placeholder="<?= $row['jenis_laptop'] ; ?>/ <?= $row['harga'] ; ?>">
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input required type="text" name="nama" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="<?= $row['nama_pembeli'] ; ?>">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Jumlah Beli</label>
                <input min="1" required type="number" name="jumlah" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $row['jumlah'] ; ?>">
            </div>
